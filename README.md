...
- **Military squads** — deploy in waves, squad members stay within 5 units of each other, non-leaders follow the leader
...
| Mechanic | Detail |
|----------|--------|
| **Visual detection** | 16u range, requires line of sight |
